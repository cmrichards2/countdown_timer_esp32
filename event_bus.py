...
class Events:
    ...
    FACTORY_RESET_BUTTON_PRESSED = 'FACTORY_RESET_BUTTON_PRESSED'
    SOFT_RESET_BUTTON_PRESSED = 'SOFT_RESET_BUTTON_PRESSED'
    WIFI_CONNECTED = 'WIFI_CONNECTED'
    WIFI_CREDENTIALS_RECEIVED = 'WIFI_CREDENTIALS_RECEIVED'
